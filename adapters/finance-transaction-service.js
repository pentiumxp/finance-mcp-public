...
function publicTransaction(row, money = {}) {
  ...
  return {
    ...
    categoryIcon: row.category_icon || row.categoryIcon || "",
    parentCategoryName: row.parent_category_name || row.parentCategoryName || "",
    parentCategoryIcon: row.parent_category_icon || row.parentCategoryIcon || "",
